...
image = cv2.imread(r"D:\MyProjects\Document Image Alignment Using ORB Features and Homography\image.jpg")
template = cv2.imread(r"D:\MyProjects\Document Image Alignment Using ORB Features and Homography\main.png")
